...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        #startPosition = abs["startingPosition"]
...
def cornersHeuristic(state, problem):
    ...
    unexploredCorners = corners
    #print(unexploredCorners)

    for i in unexploredCorners:
       # print(x)
       # print(y)
        #print(i[0])
        #print(i[1])
